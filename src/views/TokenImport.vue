<template>
  <div class="token-import-page">
    <div class="container">
      ...
      >
        <ImportTokenZhu @sucessData="handleSucessData" style="margin-bottom: 20px;" />
...
import ImportTokenZhu from '@/views/ImportTokenZhu.vue'
import {
  Add,
  CloudUpload,
  Menu,
...
// 上传完成获取token
const handleSucessData = (val, name) => {
  importForm.base64Token = val
  importForm.name = name
}
</script>
